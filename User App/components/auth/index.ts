/**
 * Entry and auth components — Batch 5.
 *
 * The first ninety seconds. Nothing here asks for anything the product does
 * not need, and the app is browsable before any of it.
 */
