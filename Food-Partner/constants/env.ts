 ...
 * partner's phone could ever switch out of.
 *
 ...
 * fine for a feature flag and never acceptable for a key.
 */
 ...
 * failed fetch is logged with the error it came from, and that error can
 * carry a restaurant's own orders, menu and payout details. `lib/log.ts`
 * gates every call site on this.
 */
