...
import { Block, Box, CheckRow, ChoiceChips, Field, ImagePick, Note, StepFrame, Tappable, TextField } from "@/components/common";
...
import { LocationRow } from "@/components/onboarding-restaurant/organisms/LocationRow";
    ...
    >
      ...
      <Block glyph="users" title="Owner & contact details">
        ...
        <Box style={styles.panel}>
          <Box style={{ flexDirection: "row", gap: space[2], alignItems: "flex-start" }}>
