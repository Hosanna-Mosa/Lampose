...
import { Block, Field, Note, NumberField, StepFrame, SwitchRow, TimeRange } from "@/components/form";
import { ChoiceChip, Icon, Seg, Stepper, Text } from "@/components/ui";
import {
  COPY,
  DAYS,
  DELIVERY_FEE_LABELS,
      ...
      <Block glyph="clock" title="Opening hours">
        ...
        {data.days.length > 0 && (
          <Field label="Opening & closing times" hint={COPY.operatingHelp}>
            ...
            <Pressable accessibilityRole="button" onPress={copyMondayEverywhere} style={styles.link}>
