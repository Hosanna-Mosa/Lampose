...
export const type = {
  /** 32/38 · 800 — splash and one-off hero figures */
  display: { fontFamily: fonts.extrabold, fontSize: 32, lineHeight: 38, letterSpacing: -0.3 },
  /** 25/30 · 800 — auth screen titles */
  pageTitle: { fontFamily: fonts.extrabold, fontSize: 25, lineHeight: 30, letterSpacing: -0.25 },
  /**
   * 24/29 · 800 — auth screen titles. The design system's type page lists H2 as
   * 700, but every screen that actually sets a 24px title sets it at 800.
   */
  pageTitleSm: { fontFamily: fonts.extrabold, fontSize: 24, lineHeight: 29, letterSpacing: -0.2 },
  /** 24/29 · 700 */
  h2: { fontFamily: fonts.bold, fontSize: 24, lineHeight: 29, letterSpacing: -0.2 },
  /** 22/26 · 800 — the standard in-content screen title */
  screenTitle: { fontFamily: fonts.extrabold, fontSize: 22, lineHeight: 26, letterSpacing: -0.2 },
  /** 18/23 · 600 */
  h3: { fontFamily: fonts.semibold, fontSize: 18, lineHeight: 23 },
