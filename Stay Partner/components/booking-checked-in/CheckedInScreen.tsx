...
import { Step } from '@/components/booking-checked-in/molecules/Step/Step';
...
export function CheckedInScreen() {
  ...
  return (
    ...
    >
      <Box style={[styles.hero, { backgroundColor: bothIn ? c.successTint : c.accentTint }]}>
        <Box style={[styles.heroIcon, { backgroundColor: bothIn ? c.success : c.accent }]}>
