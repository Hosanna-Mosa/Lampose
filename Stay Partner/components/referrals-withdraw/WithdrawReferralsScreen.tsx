...
import { Screen, Text, Button, IconButton, Select, EmptyState } from '@/components/common';
 ...
 */
export function WithdrawReferralsScreen() {
  const c = useColors();
  ...
  return (
    ...
    >
      ...
      <Box style={[styles.amountCard, { backgroundColor: c.successTint }]}>
      ...
      {hasMethods ? (
        ...
        <Box style={[styles.noMethod, { borderColor: c.borderCard, backgroundColor: c.surface }]}>
