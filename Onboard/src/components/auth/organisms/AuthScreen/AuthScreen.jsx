...
import { Box, Form, Heading, Image, Inline, Input, Label, PlainButton, Text } from '../../../common/atoms';
  ...
  return (
    <Box style={{
      ...
      <Box style={{
        ...
        {/* Brand Logo Header */}
        <Box style={{ textAlign: 'center', marginBottom: '28px' }}>
          <Image
          ...
          />
          <Heading level={2} style={{ fontSize: '1.45rem', fontWeight: 800, color: '#181e1b', letterSpacing: '-0.02em' }}>
            Employee Portal Login
          </Heading>
          <Text style={{ fontSize: '0.84rem', color: '#64748b', marginTop: '4px' }}>
          ...
          >
            {loading ? (
              <>
                ...
                <Inline>Verifying Credentials...</Inline>
              </>
            ) : (
              <>
                <LogIn size={19} />
                <Inline>Sign In to Onboarding Panel</Inline>
              </>
            )}
          </PlainButton>
        </Form>
