...
export function PropertyCard({ property, onViewDetails }) {
  ...
  return (
    ...
    >
      ...
      <Box className="card-image-box" style={{ position: 'relative', height: '205px', overflow: 'hidden', background: '#f6f8f6' }}>
        <Image
          key={currentImgIndex}
        ...
        <Box style={{ position: 'absolute', top: '10px', left: '10px', zIndex: 2 }}>
          <Inline style={{
            background: '#ffffff',
            color: '#181e1b',
            padding: '4px 10px',
        ...
        {verificationStatus === 'pending' ? (
          <Box style={{ position: 'absolute', top: '10px', right: '10px', zIndex: 2 }}>
            <Inline style={{
              fontSize: '0.72rem',
              fontWeight: 800,
              padding: '4px 10px',
        ...
        {allImages.length > 1 && (
          <Box style={{
            ...
            <Inline>📷 {currentImgIndex + 1}/{allImages.length}</Inline>
          </Box>
        )}
        ...
        <Box style={{
          ...
          <Inline style={{ fontSize: '0.8rem', color: '#181e1b', fontWeight: 800 }}>₹</Inline>
          <Inline style={{ fontSize: '1.15rem', fontWeight: 800, color: '#181e1b', letterSpacing: '-0.02em' }}>{displayPrice}</Inline>
          <Inline style={{ fontSize: '0.7rem', color: '#64748b', fontWeight: 600 }}>
            {isDaily ? '/day' : '/mo'}
          </Inline>
        </Box>
      </Box>
      ...
      <Box style={{ padding: '18px', display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        {/* Location Tag */}
        <Box style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#64748b', fontSize: '0.85rem', marginBottom: '8px' }}>
        ...
        {activeEmpEmail && (
          <Box style={{ display: 'flex', alignItems: 'center', gap: '5px', fontSize: '0.75rem', color: '#45855a', fontWeight: 600, marginBottom: '10px' }}>
            <UserCheck size={13} color="#45855a" />
            <Inline style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
        ...
        {topAmenities.length > 0 && (
          <Box style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginBottom: '14px' }}>
            ...
            {amenities.length > 3 && (
              <Inline style={{ fontSize: '0.72rem', color: '#64748b', alignSelf: 'center' }}>
        ...
        <Box style={{
          ...
          <Box style={{ display: 'flex', flexDirection: 'column' }}>
            <Inline style={{ fontSize: '0.72rem', color: '#64748b' }}>Owner / Contact</Inline>
            <Inline style={{ fontSize: '0.84rem', fontWeight: 700, color: '#181e1b' }}>
              {ownerName}
            </Inline>
          </Box>
